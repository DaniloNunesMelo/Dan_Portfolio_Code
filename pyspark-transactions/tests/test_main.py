...
Targets previously uncovered lines 30-58, 67-77, 113-132,
136-139 from the coverage report.
"""
...
class TestCreateSparkSession:
    def test_returns_spark_session(self, spark):
        """Use the existing session from conftest."""
...
class TestRunPipeline:
    ...
    def pipeline_files(self, tmp_path):
        """Create minimal CSVs and a config dict."""
        ...
        claims.write_text(
            "SOURCE_SYSTEM,CLAIM_ID,"
            "CONTRACT_SOURCE_SYSTEM,CONTRACT_ID,"
            "CLAIM_TYPE,DATE_OF_LOSS,AMOUNT,"
            "CREATION_DATE\n"
            "Claim,CL_123,SYS_A,100,2,"
            "14.02.2021,500,17.01.2022 14:45\n",
            encoding="utf-8",
        )
...
class TestMain:
    def test_main_with_valid_args(self, tmp_path, spark):
        ...
        claims.write_text(
            ...
            "CREATION_DATE\n"
            "S,CL_1,S,1,1,"
            "01.01.2020,10,01.01.2020 10:00\n",
            encoding="utf-8",
        )
